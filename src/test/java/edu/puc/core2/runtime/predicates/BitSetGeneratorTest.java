...
import edu.puc.core2.parser.QueryParser;
...
import edu.puc.core2.parser.plan.exceptions.EventException;
import edu.puc.core2.parser.plan.exceptions.StreamException;
...
public class BitSetGeneratorTest {
    ...
    @Test
    public void testChecker() throws edu.puc.core2.exceptions.EventException {
        BitSetGenerator checker = new BitSetGenerator(PredicateFactory.getInstance());
        BitSet vector = checker.getBitSetFromEvent(new edu.puc.core2.runtime.events.Event("SS1", "Temp1", 1L, 42.2));
