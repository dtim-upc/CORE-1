package edu.puc.core2.runtime.events;

import edu.puc.core2.exceptions.EventException;
...
public class Event {
    ...
    public Event(String streamName, String eventName, Object... args) throws EventException {
        ...
        edu.puc.core2.parser.plan.Event eventSchema = edu.puc.core2.parser.plan.Event.getSchemaFor(eventName);
        if (eventSchema == null)
